    ...
    <th colspan="5" bgcolor="#FFFFFF">    	      
    	<table  width="924" border="0" align="center" >             
        	<tr>
                ...
                <ul>&nbsp;&nbsp;&nbsp;A glossy, easy gliding gel to tame, tidy and<br>groom eyebrows.</ul>
                <span class="headdetail"><ul>Color : </ul></span><ul>&nbsp;&nbsp;&nbsp;Oural</ul>
            ...
            <tr>
            	<td class="namePro">BROW GEL </td>
                                                                          
         	</tr>                   
        	<tr>
            	<td rowspan="3"><img src="images/products/EYEBROW/NARS.jpg" width="306" height="306" /></td>                
            </tr>
            <tr>
            	<td>&nbsp;</td>                
            </tr>
            <tr>
            	...
            	<td align="right"><input type="image" name="add" value="BROW GEL" img src="images/add_detail.png"/></td>
                </form>                  
            </tr>
